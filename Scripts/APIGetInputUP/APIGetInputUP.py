...
def run(context):
    ...
    try:
        ...
        defaultVal = "5.0 mm" #create a default value to display
        newInput = ui.inputBox('enter a new input val','New Input val', defaultVal) #input box within the UI, add default value inside
        ...
        try:
            ...
            isValid = False 
        ui.messageBox('Input', + defaultVal + 'result' + NewInputReal) # input new values for user parameter and display in textbox
    except:
        if ui:
